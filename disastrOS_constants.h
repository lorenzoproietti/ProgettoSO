...
#define DSOS_ESEMOPEN_SEMNUM_VALUE -15
#define DSOS_ESEMCLOSE_SEMD_NOT_IN_PROCESS -16
#define DSOS_ESEMWAIT_SEMD_NOT_IN_PROCESS -17
#define DSOS_ESEMPOST_SEMD_NOT_IN_PROCESS -18
